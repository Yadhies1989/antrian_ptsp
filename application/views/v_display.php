<div class="row">
    <center class="col-md-12" style="background-color:#2c3e50; margin-top:40px;">
        <center>
            <h1 style='font-family: arial;color:#ecf0f1;font-size:40px'>Antrian Pelayanan Terpadu Satu Pintu (PTSP) <br><?php echo ucwords(strtolower($satker)); ?></h1>
        </center>
        <center>
                ...
                <div class="col-12 col-lg-6 col-xl-3 col-md-4 mx-auto" style="margin-top:20px;">
                    <div class="widget widget-stats" style="opacity:0.8;background-color:#16a085;">
                        <div style="text-align: center">
                            ...
                            <p><span class="badge badge-pill badge-danger" id="no-antrian-<?php echo $row->no_loket; ?>">
